...
var path = '0', //组件存放目录，为空表示自动获取(不用填写host，相对站点的根目录即可)。
...
Class.pt.config = {
    ...
    zIndex: 19891014, 
    maxWidth: 400,
    dialog: {btns: 1, btn: ['Ok','Cancel'], type : 8, msg: '', yes: function(index){layer.close(index);}, no: function(index){layer.close(index);}},
